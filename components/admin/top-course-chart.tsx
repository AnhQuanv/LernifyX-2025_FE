...
export function TopCoursesChart({ data }: { data?: CourseDataItem[] }) {
  ...
  if (!data || data.length === 0) {
    return (
      <div className="bg-card rounded-lg p-6 border border-border h-100 flex items-center justify-center">
  ...
  return (
    <div className="bg-card rounded-lg p-6 border border-border shadow-sm">
      <h3 className="text-lg font-semibold text-foreground mb-4">
        Top 10 Khóa Học Doanh Thu Cao Nhất (VNĐ)
      </h3>
